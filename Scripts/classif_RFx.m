...
%X = [L1H; L1V]'; %Datos de entrenamiento

% 1.2 Configuración target
T = repmat([1 2 3 4 5],4,1); %Se crea una matriz con las etiquetas posibles para las muestras (2 filas, 1 columna)
